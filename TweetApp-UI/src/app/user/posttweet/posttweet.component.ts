...
export class PosttweetComponent implements OnInit {
  ...
  ngOnInit() {
    this.tweetform = this.frombuilder.group({
  ...
  onSubmitPost(){
    ...
    if(this.tweetform.invalid){
     return;
      ...
      this.tweet.tweets=this.tweetform.value["tweets"];
      ...
      this.tweet.likes =this.tweetform.value["likes"];
      console.log(this.tweet)
     this.service.Tweet(this.tweet).subscribe(res=>{
